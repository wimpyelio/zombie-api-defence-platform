 ...
 */
export function getHighlightedNodes(graph: KnowledgeGraph, nodeId: string | number | null): Set<string | number> {
 ...
 */
export function renderKnowledgeGraph(graph: KnowledgeGraph, highlighted: Set<string | number> = new Set()): string {
